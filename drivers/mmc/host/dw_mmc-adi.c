...
//static void dwmmc_adi_prepare_command(struct dw_mci *host, u32 *cmd)
//{
...
static const struct dw_mci_drv_data adi_drv_data = {
	...
	//.prepare_command	= dwmmc_adi_prepare_command,
};
...
/*
static const struct dev_pm_ops dwmmc_adi_pmops {
};
*/
