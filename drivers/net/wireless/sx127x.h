...
enum sx127x_ioctl_cmd {
	...
	SX127X_IOCTL_CMD_GETLORASYNCWORD,
	SX127X_IOCTL_CMD_SETLORASYNCWORD,
	SX127X_IOCTL_CMD_GETIMPLICITHEADMODE,
	SX127X_IOCTL_CMD_WRITEREGISTER,
	SX127X_IOCTL_CMD_READREGISTER,
        SX127X_IOCTL_CMD_IRQOUTON,
        SX127X_IOCTL_CMD_IRQOUTOFF,
        SX127X_IOCTL_CMD_IRQINEN
};
