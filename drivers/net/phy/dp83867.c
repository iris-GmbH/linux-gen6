...
#include <dt-bindings/phy/ti-dp83867.h>
...
static int dp83867_config_init(struct phy_device *phydev)
{
	 ...
	 *
	 * This pin should be configured as INT_OE on ADI SC5XX boards in order to
	 * prevent the signal interference from PPI0_FS3 during PPI is running at
	 * the same time.
	 */
