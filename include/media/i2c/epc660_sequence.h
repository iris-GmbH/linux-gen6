...
#define USE_INITCODE_V11				1
#define USE_INITCODE_V11_ORIGINAL_END	0
...
#if USE_INITCODE_V11
/* EPC660 Sequencer programm according to Datasheet_epc660_Rev2_15.pdf, section 15.12, page 62ff.
...
static const u8 epc660_003_Seq_Prog_8MHz_Default_8[] = {
	...
	9, 0x40, 0x74, 0x00, 0x48, 0x00, 0x00, 0x00, 0x00, 0x0D,
	9, 0x40, 0x75, 0x00, 0x08, 0x00, 0x00, 0x4C, 0x00, 0x0D,
...
#if USE_INITCODE_V11_ORIGINAL_END
	2, 0x47, 0x00,
	2, 0x91, 0x03,
#else // USE_INITCODE_V11_ORIGINAL_END
	2, 0x47, 0x00,
	2, 0x91, 0x43,	// SEQ_Control: activate HSYNC stretch
	2, 0x90, 0xEC,
	2, 0xAB, 0x04,
	2, 0xAE, 0x01,
#endif // USE_INITCODE_V11_ORIGINAL_END
	EPC660_I2CSEQ_TERMINATE
}; // epc660_003_Seq_Prog_8MHz_Default_8

#else // USE_INITCODE_V11
