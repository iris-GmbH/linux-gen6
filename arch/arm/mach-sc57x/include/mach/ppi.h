...
/*
 * All SC57X system MMRs are padded to 32bits even if the register
...
/* Current Field Received by EPPI */
#define EPPI_STAT_FLD                   0x00008000
/* Holds the number of samples to read in or write out per line, after PPIx
 * HDLY number of cycles have expired since the last assertion of PPIx_FS1 */
#define EPPI_HCNT_VALUE                 0x0000FFFF
/* Number of PPIx_CLK cycles to delay after assertion of PPIx_FS1 before
 * starting to read or write data */
#define EPPI_HDLY_VALUE                 0x0000FFFF
/* Holds the number of lines to read in or write out, after PPIx_VDLY number of
 * lines from the start of frame */
#define EPPI_VCNT_VALUE                 0x0000FFFF
/* Number of lines to wait after the start of a new frame before starting to
 * read/transmit data */
#define EPPI_VDLY_VALUE                 0x0000FFFF
/* Holds the number of lines expected per frame of data */
#define EPPI_FRAME_VALUE                0x0000FFFF
/* Holds the number of samples expected per line */
...
/* XFRTYPE: ITU656 Active Video Only Mode */
#define EPPI_CTL_ACTIVE656              0x00000000
/* XFRTYPE: ITU656 Entire Field Mode */
#define EPPI_CTL_ENTIRE656              0x00000004
/* XFRTYPE: ITU656 Vertical Blanking Only Mode */
#define EPPI_CTL_VERT656                0x00000008
/* XFRTYPE: Non-ITU656 Mode (GP Mode) */
...
/* In GP transmit mode with BLANKGEN = 1, contains number of lines of vertical
...
/* In GP 2, or 3 FS modes used to generate PPIx_FS2 width (32-bit). In GP
 * Transmit mode, with BLANKGEN=1, contains the number of lines of Vertical
 * blanking before field 1.*/
#define EPPI_FS2_WLVB_F1VBBD            0x000000FF
/* Number of lines of Active Data in Field 2 */
#define EPPI_FS2_PALPF_F2ACT            0xFFFF0000
/* Number of lines of Active Data in Field 1 */
#define EPPI_FS2_PALPF_F1ACT            0x0000FFFF
/* Mask CFIFO Underflow or Overflow Error Interrupt */
#define EPPI_IMSK_CFIFOERR              0x00000001
/* Mask YFIFO Underflow or Overflow Error Interrupt */
#define EPPI_IMSK_YFIFOERR              0x00000002
/* Mask Line Track Overflow Error Interrupt */
#define EPPI_IMSK_LTERROVR              0x00000004
/* Mask Line Track Underflow Error Interrupt */
#define EPPI_IMSK_LTERRUNDR             0x00000008
/* Mask Frame Track Overflow Error Interrupt */
#define EPPI_IMSK_FTERROVR              0x00000010
/* Mask Frame Track Underflow Error Interrupt */
#define EPPI_IMSK_FTERRUNDR             0x00000020
/* Mask ITU Preamble Error Not Corrected Interrupt */
#define EPPI_IMSK_ERRNCOR               0x00000040
/* Mask PxP Ready Error Interrupt */
